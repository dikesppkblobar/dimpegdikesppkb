          ...
          <div className="bg-white border border-slate-200 rounded-2xl max-w-lg w-full p-6 shadow-2xl text-left space-y-4">
            ...
            <div className="space-y-1.5 p-3 bg-slate-50 rounded-xl border border-slate-150">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                >
                  <span className="text-sm font-bold">📱 Aplikasi WhatsApp</span>
                  <span className="text-[10px] text-slate-400 font-normal leading-tight font-sans">Terhubung langsung ke aplikasi WA tanpa buka tab baru</span>
                </button>
                ...
                >
                  <span className="text-sm font-bold">💻 WhatsApp Web (1 Tab)</span>
